...
const Navbar = ({ userId, setUserId, onShowAuthModal }) => {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row navbar bg-gradient-to-br from-[#1a1440] via-[#0e0a1a] to-[#2a0a2a] border-zinc-700 text-neutral-content justify-between px-2 md:px-6 mb-10 md:mb-52 w-full">
        <div
          className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-900 to-pink-600 bg-clip-text text-transparent pl-2 md:pl-8 cursor-pointer mb-2 md:mb-0"
