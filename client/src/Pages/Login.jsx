    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ color: '#fff', fontSize: '28px', fontWeight: '700', margin: 0 }}>Welcome Back!</h2>
          <p style={{ color: 'rgba(255,255,255,0.75)', marginTop: '6px', fontSize: '14px' }}>Sign in to your account to continue.</p>
        </div>
          ...
          <button type="submit" className="auth-btn" disabled={isLoading}>
            {isLoading ? (
              <>
                ...
                <span>Logging In<span className="dots"></span></span>
              </>
            ) : (
              'Login'
            )}
