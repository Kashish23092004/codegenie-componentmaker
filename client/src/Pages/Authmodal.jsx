      ...
      <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center">
        <div className="relative px-2 w-full max-w-md">
          ...
          >
            {/* Heading */}
            <div
              className="bg-gradient-to-r from-[#321767] via-[#20113F] to-[#6C2BD7] flex flex-col items-center"
            ...
            >
              {error && (
                <div className="px-4 py-2 bg-red-50 border border-red-200 text-red-600 rounded text-center text-sm">
                  {error}
                </div>
              )}
